...
if(ticket_get_information($tid)['sid'] === $uid){
    ...
    echo '<link rel="stylesheet" type="text/css" href="/modules/Evo-TSM/pages_user/assets/css/print.css" media="print">';
    echo '<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.2/jspdf.min.js"></script>';
    echo '<script type="text/javascript" src="/modules/Evo-TSM/pages_user/assets/js/jquery.validate.min.js"></script>';
