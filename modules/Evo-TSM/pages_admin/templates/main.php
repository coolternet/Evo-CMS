...
<div class="plugin_header bg-grad-evo">
    <div class="container header">
        <div class="title left"><h3 class="text-white"><?= function_exists('__') ? __('Evo-TSM/tss_header.name') : 'Evo-TSM'; ?></h3>
            <span class="text-secondary small small"><?= function_exists('__') ? __('Evo-TSM/tss_header.version') : 'Version'; ?> : <?= App::getModule('Evo-TSM')->version ?></span><br/>
            <span class="text-secondary small"><?= function_exists('__') ? __('Evo-TSM/tss_header.author') : 'Auteur'; ?> : <?= is_array(App::getModule('Evo-TSM')->author ?? 'Evo-CMS Team') ? implode(', ', App::getModule('Evo-TSM')->author) : (App::getModule('Evo-TSM')->author ?? 'Evo-CMS Team') ?></span>
        </div>
        <div class="opt right text-end text-white d-none d-md-block">
            <div class="input-group">
                ...
                <?php
                // Vérifier si le cache est installé
