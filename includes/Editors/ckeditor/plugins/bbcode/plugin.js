...
( function() {
	...
	var bbcodeMap = { b: 'strong', u: 'u', i: 'em', s: 's', color: 'span', bgcolor: 'span', size: 'span', font: 'span', left: 'div', right: 'div', center: 'div', justify: 'div', quote: 'blockquote', code: 'pre', url: 'a', email: 'span', img: 'span', '*': 'li', list: 'ol' , table: 'table', tr: 'tr', td: 'td', th: 'th', hr: 'hr' },
		convertMap = { strong: 'b', b: 'b', u: 'u', em: 'i', i: 'i', s: 's', pre: 'code', li: '*', table: 'table', tr: 'tr', td: 'td', th: 'th', hr: 'hr' },
		tagnameMap = { strong: 'b', em: 'i', u: 'u', s: 's', li: '*', ul: 'list', ol: 'list', pre: 'code', a: 'link', img: 'img', blockquote: 'quote', table: 'table', tr: 'tr', td: 'td', th: 'th', hr: 'hr' },
		stylesMap = { color: 'color', bgcolor: 'background-color', size: 'font-size', font: 'font-family', left: 'text-align', center: 'text-align', right: 'text-align', justify: 'text-align' },
		attributesMap = { url: 'href', quote: 'cite', list: 'listType' };
				...
				if ( ( filters = editor._.elementsPath.filters ) ) {
					filters.push( function( element ) {
						...
						// Styled span could be either size or color.
							...
							if ( element.getStyle( 'font-family' ) )
								name = 'font';
