...
use GeoIp2\WebService\Client as WsClient;
...
class Client implements ProviderInterface
{
    ...
    private function responseFor($endpoint, $class, $ipAddress)
    {
        ...
        } catch (\GeoIp2\Exception\InsufficientFundsException $ex) {
            throw new OutOfQueriesException(
                $ex->getMessage(),
                $ex->getStatusCode(),
                $ex
            );
        } catch (\GeoIp2\Exception\InvalidRequestException $ex) {
        ...
        } catch (\GeoIp2\Exception\HttpException $ex) {
        ...
        } catch (\GeoIp2\Exception\WebServiceException $ex) {
