...
use GeoIp2\Db\Reader as DbReader;
use GeoIp2\Db\Reader\InvalidDatabaseException;
 ...
 * corrupt or invalid, a {@link \GeoIp2\Db\Reader\InvalidDatabaseException}
 * will be thrown.
 */
class Reader implements ProviderInterface
{
     ...
     *
     * @throws \GeoIp2\Db\Reader\InvalidDatabaseException if the database
    ...
    private function getRecord($class, $type, $ipAddress)
    {
        ...
        if (!\is_array($record)) {
            ...
            // GeoIp2\Db\Reader will throw a
            // GeoIp2\Db\Reader\InvalidDatabaseException, but occasionally
     ...
     *
     * @return \GeoIp2\Db\Reader\Metadata object for the database
     */
